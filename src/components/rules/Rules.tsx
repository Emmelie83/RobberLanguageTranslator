...
const Rules: React.FC = () => (
	<section
		id="rules"
		className="rules-content flex justify-center bg-no-repeat bg-center -mt-70 bg-contain h-[850px] pb-60">
		<div className="text-center w-full max-w-2xl px-6 mt-20">
